...
class MainMenuScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        howToBtn.position = CGPoint(x: CGRectGetMidX(self.frame), y: (CGRectGetMidY(self.frame)-50.0))
        ...
        creditsBtn.position = CGPoint(x: CGRectGetMidX(self.frame), y: (CGRectGetMidY(self.frame)-200.0))
